...
/* proj 2 struct to implement wait syscall */
struct wait_status {
  int exit_code;
...
/* New entry in the file descriptor table to handle directories or files */
struct fd_entry {
  bool in_use; /* Does this entry have a valid pointer/is_dir. */
...
struct thread
  {
    ...
    /* Proj 2:3 - Shared by thread.c/userprog/syscall.c */
    struct fd_entry fd_table[MAX_FILE_DESCRIPTORS];
    unsigned int num_fds;
    struct file *file;
    /* proj 2:2 - Shared by thread.c/userprog/process.c */
